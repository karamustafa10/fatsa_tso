...
<body style=" background-color: #8a8583; ">
    ...
    <div class="container-xxl">
        <div class="card text-center w-auto mb-3" style=" height: 650px; background-color: #f7efd2; border-color: #f7efd2; ">
            <div class="card-body">
                <h1 class="card-title">Üyelik Güncelle</h1>
                <br>
                <p>
                    <form action="uye_guncelleme_yap.php" method="POST">
                        ...
                        <button type=" submit " class="btn btn-dark btn-block mb-4">Güncelle</button>
