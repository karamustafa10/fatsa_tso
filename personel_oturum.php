...
<body style=" background-color: #8a8583; ">
    ...
    <div class="container-xxl">
        <div class="card text-center w-auto mb-3" style=" height: 450px; background-color: #f7efd2; border-color: #f7efd2; ">
            <div class="card-body">
                <h1 class="card-title">Personel Girişi</h1>
                <br>
                <p>
                    <form action="personel_oturum_aktif.php" method="POST">
                        
                        <div class="form-outline mb-4">
                            <input type="text" name="personel_ad" class="form-control" />
                            <label class="form-label" >AD</label>
                        </div>

                        <div class="form-outline mb-4">
                            <input type="text" name="personel_soyad" class="form-control" />
                            <label class="form-label" >SOYAD</label>
                        </div>

                        
                        <div class="form-outline mb-4">
                            <input type="password" name="personel_sifre" class="form-control" />
